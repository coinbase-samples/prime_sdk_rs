...
/// WalletClaimRewardsInputs : WalletClaimRewardsInputs contains the custom inputs for claim rewards operations on a wallet. Requirements and supported fields vary by asset type.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct WalletClaimRewardsInputs {
    /// Optional amount to claim rewards (ETH only). If omitted, the wallet will claim the maximum amount available
    #[serde(rename = "amount", skip_serializing_if = "Option::is_none")]
    pub amount: Option<String>,
}
impl WalletClaimRewardsInputs {
    ...
    pub fn new() -> WalletClaimRewardsInputs {
