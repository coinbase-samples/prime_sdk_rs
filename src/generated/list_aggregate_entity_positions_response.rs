...
use crate::types::generated::generated::position::Position;
...
impl ListAggregateEntityPositionsResponse {
    pub fn new(positions: Vec<Position>, pagination: PaginatedResponse) -> ListAggregateEntityPositionsResponse {
