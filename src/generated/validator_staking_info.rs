...
use crate::types::generated::generated::staking_status::StakingStatus;
...
pub struct ValidatorStakingInfo {
    ...
    pub statuses: Vec<StakingStatus>,
}
impl ValidatorStakingInfo {
    pub fn new(validator_address: String, statuses: Vec<StakingStatus>) -> ValidatorStakingInfo {
