...
/// WalletStakeInputs : WalletStakeInputs contains the custom inputs for staking operations on a wallet. Requirements and supported fields vary by asset type.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct WalletStakeInputs {
