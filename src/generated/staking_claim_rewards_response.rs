...
pub struct StakingClaimRewardsResponse {
    /// The wallet ID
...
impl StakingClaimRewardsResponse {
    pub fn new(wallet_id: String, transaction_id: String, activity_id: String) -> StakingClaimRewardsResponse {
        StakingClaimRewardsResponse {
            wallet_id,
            transaction_id,
            activity_id,
        }
